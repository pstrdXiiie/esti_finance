...
CUSTOM_FIELDS = {
	"Student": [
		...
		{"fieldname": "suffix", "label": "Suffix", "fieldtype": "Data", "insert_after": "lrn"},
		{"fieldname": "column_break_sms_1", "fieldtype": "Column Break", "insert_after": "suffix"},
		...
		{"fieldname": "religion", "label": "Religion", "fieldtype": "Link", "options": "SMS Code",
			"description": "Filtered to SMS Code.code_type = Religion", "insert_after": "discount_type"},
		{"fieldname": "transfer_section", "fieldtype": "Section Break", "label": "Transfer & Graduation History", "insert_after": "religion"},
		...
		{"fieldname": "pr_no", "label": "PR No.", "fieldtype": "Data", "insert_after": "year_graduated"},
		{"fieldname": "school_history_section", "fieldtype": "Section Break", "label": "School History (PH Basic Ed)", "collapsible": 1, "insert_after": "pr_no"},
		...
		{"fieldname": "column_break_sms_ncae", "fieldtype": "Column Break", "insert_after": "year_secondary"},
		{"fieldname": "ncae_no", "label": "NCAE No.", "fieldtype": "Data", "insert_after": "column_break_sms_ncae"},
		{"fieldname": "column_break_sms_vocational", "fieldtype": "Column Break", "insert_after": "ncae_no"},
		{"fieldname": "vocational", "label": "Vocational School", "fieldtype": "Data", "insert_after": "column_break_sms_vocational"},
		{"fieldname": "year_vocational", "label": "Year Graduated (Vocational)", "fieldtype": "Int", "insert_after": "vocational"},
		{"fieldname": "column_break_sms_6", "fieldtype": "Column Break", "insert_after": "year_vocational"},
	...
	"Program": [
		...
		{"fieldname": "semesters", "label": "Semesters", "fieldtype": "Select", "options": "1\n2\n3",
			"description": "Number of semester terms this course runs per year", "insert_after": "sem_type"},
		{"fieldname": "column_break_sms_prog_1", "fieldtype": "Column Break", "insert_after": "semesters"},
		...
		{"fieldname": "tuition_fee", "label": "Tuition Fee", "fieldtype": "Currency", "insert_after": "misc_fee_code"},
		{"fieldname": "course_desc", "label": "Long Description", "fieldtype": "Text Editor", "insert_after": "tuition_fee"},
	],
	"Course": [
	...
	"Student Group": [
		{"fieldname": "sms_offering_section", "fieldtype": "Section Break", "label": "Class Offering (PH Registrar)", "insert_after": "course"},
		{"fieldname": "section", "label": "Section", "fieldtype": "Data", "insert_after": "sms_offering_section"},
		{"fieldname": "year_level", "label": "Year Level", "fieldtype": "Int", "insert_after": "section"},
		{"fieldname": "semester", "label": "Semester", "fieldtype": "Int", "insert_after": "year_level"},
	...
	"Course Enrollment": [
		...
		{"fieldname": "year_level", "label": "Year Level", "fieldtype": "Int", "read_only": 1,
			"description": "Derived from the course's position on the program's active SMS Curriculum at enroll() time — not hand-edited", "insert_after": "student_group"},
		{"fieldname": "semester", "label": "Semester", "fieldtype": "Int", "read_only": 1,
			"description": "Derived from the course's position on the program's active SMS Curriculum at enroll() time — not hand-edited", "insert_after": "year_level"},
		{"fieldname": "sms_grading_section", "fieldtype": "Section Break", "label": "Grading (PH fixed-period)", "insert_after": "semester"},
