  ...
  fields: [
    {
      ...
      options: "SMS Student",
      dropdown: true,
      linkLabelFields: ["student_number", "first_name", "last_name"],
      inListView: true,
    ...
    { fieldname: "assessment", label: "Assessment", fieldtype: "Currency", section: "Balances" },
    { fieldname: "amount", label: "Amount", fieldtype: "Currency", section: "Balances" },
    { fieldname: "balance", label: "Balance", fieldtype: "Currency", inListView: true, section: "Balances" },
    {
      fieldname: "payment",
      label: "Payment",
      fieldtype: "Select",
    ...
    { fieldname: "adj_bal", label: "Adjustment Balance", fieldtype: "Currency", section: "Adjustments" },
  ],
}
