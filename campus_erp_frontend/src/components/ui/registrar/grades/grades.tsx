  ...
  return (
    <Tabs defaultValue="all-grades" orientation="vertical" className="flex-row items-stretch bg-card p-4 rounded-lg shadow-md w-full h-[78vh] border border-border print:h-auto print:border-0 print:shadow-none print:p-0">
      <TabsList className="grid w-48 grid-cols-1 gap-5 border-0 bg-card mr-4 h-[50vh]! shrink-0 print:hidden">
            ...
            <TabsTrigger value="by-class" className="w-full gap-2 p-3 border-border data-active:bg-primary data-active:text-primary-foreground">
                By Class
            </TabsTrigger>
            <TabsTrigger value="by-teacher" className="w-full gap-2 p-3 border-border data-active:bg-primary data-active:text-primary-foreground">
                By Teacher
            </TabsTrigger>
            <TabsTrigger value="transferee-grades" className="w-full gap-2 p-3 border-border data-active:bg-primary data-active:text-primary-foreground">
                Transferee Grades
            </TabsTrigger>
            <TabsTrigger value="old-student-grades" className="w-full gap-2 p-3 border-border data-active:bg-primary data-active:text-primary-foreground">
                Old Student Grades
            </TabsTrigger>
        </TabsList>
